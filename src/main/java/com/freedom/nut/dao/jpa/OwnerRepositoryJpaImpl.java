package com.freedom.nut.dao.jpa;
...
public class OwnerRepositoryJpaImpl implements OwnerRepository {
    ...
    public List<Owner> findByFirstName(String firstName) {
        return entityManager.createQuery("from Owner where firstName = :firstName", Owner.class).setParameter("firstName", firstName).getResultList();
    }
